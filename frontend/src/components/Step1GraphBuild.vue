    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM이 문서 내용과 시뮬레이션 요구사항을 분석하여 현실 시드를 추출하고 적절한 온톨로지 구조를 자동 생성합니다
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            생성된 온톨로지를 기반으로 문서를 자동 분할 후 Zep을 호출하여 지식 그래프를 구축하고, 개체와 관계를 추출하며 시계열 메모리와 커뮤니티 요약을 생성합니다
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">SCHEMA 타입</span>
            </div>
          </div>
        </div>
      </div>
