"""
Profile 형식 생성이 OASIS 요구사항에 부합하는지 테스트
검증:
1. Twitter Profile CSV 형식 생성
2. Reddit Profile JSON 상세 형식 생성
"""
...
def test_profile_formats():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Reddit JSON 형식 테스트
        print("\n2. Reddit Profile 테스트 (JSON 상세 형식)")
        print("-" * 40)
